...
double newIm;
   ...
   * @return -this
   */
  public ComplexNumber negate() {      //A stub: to be fixed
      real = -real;
      imaginary = -imaginary;       
      return this;
  }
  ...
  public ComplexNumber add(ComplexNumber z) {
      newRe = -real + z.real;
      newIm = -imaginary + z.imaginary;
      return new ComplexNumber(newRe, newIm);  //A stub: to be fixed
  }
  ...
  public ComplexNumber multiply(ComplexNumber z) {
      newRe = ((-real*z.real)-(-imaginary*z.imaginary));
      newIm = ((-real*z.imaginary)-(imaginary*z.real));
      return new ComplexNumber(newRe, newIm);  //A stub: to be fixed
  }
  ...
  public ComplexNumber reciprocal() {
      newRe = -real/((real*real)+ (imaginary*imaginary));
      newIm = imaginary/((real*real)+ (imaginary*imaginary));
      return new ComplexNumber(newRe, newIm);  //A stub: to be fixed
  }
  ...
  public ComplexNumber divide(ComplexNumber z) {
      newRe = -1.0*((imaginary*z.imaginary)+(real*z.real))/((z.real*z.real)+(z.imaginary*z.imaginary));
      newIm = -1.0*((imaginary*z.real)-(real*z.imaginary))/((z.real*z.real)+(z.imaginary*z.imaginary));
      return new ComplexNumber(newRe, newIm);  //A stub: to be fixed
  }
